...
object ProviderProfiles {
    ...
    enum class ThinkingKind(val paramLabel: String) {
         ...
         * chat_template_kwargs 包一层（2026-09-18 官方文档逐条抄录，见 Android 台账 §四第 10 条）。
         */
     ...
     * 生图协议。
     *
     * P2-D8：两种口径的中文说明都挂在枚举上，别在界面里各写一份 `when`
    ...
    data class ProviderProfile(
         ...
         * 置 true 后 AiClient 每次请求都会带上该参数（P1-A，2026-09-15）。
         */
         ...
         * 只有一手核实过的家才填（硅基流动、OpenAI 官方，依据见 `docs/鲸鱼-TTS-v2-调研与设计.md`）——
    ...
    /**
     * 该家是否需要在每次请求里显式要求"把思考拆出去"（P1-A，2026-09-15）。
     *
