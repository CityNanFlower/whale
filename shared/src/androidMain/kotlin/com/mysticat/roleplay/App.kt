...
class App : Application(), SingletonImageLoader.Factory {
    override fun onCreate() {
        super.onCreate()
        // 跨平台拆分时去 Context：注入宿主目录（数据仍在 files/roleplay/，行为不变），
        ...
        // 跨平台拆分第四步：平台服务注入（SAF/Toast/相册/分享/权限/剪贴板/编解码 + 语音三件套）。
        ...
        // 退到后台就把 BGM 停掉。没有前台服务也没有通知，放着不管的话用户离开 App
